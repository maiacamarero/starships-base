...
public class BulletFactory {
    ...
    public static Bullet generate(Ship ship){
        ...
        return new Bullet(id, new Position(ship.getPosition().getX()+16, ship.getPosition().getY()), ship.getRotationInDegrees()-20, r*12, r*4, ship.getRotationInDegrees(), ship.getId(), (r*13), ship.getBulletType());
